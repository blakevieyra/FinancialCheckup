...
export const MORE_TOOL_SECTIONS = [
  ...
  },
  {
    ...
    pro: true,
    tools: [
      { id: 'ai', label: 'AI insights & plan', desc: 'Scored category plans, debt & investment guidance with sources' },
      { id: 'expert', label: 'Expert briefing', desc: 'Executive-style strategy summary' },
    ],
  },
  {
    id: 'projections',
